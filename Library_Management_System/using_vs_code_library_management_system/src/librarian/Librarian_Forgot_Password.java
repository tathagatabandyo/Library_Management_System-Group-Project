...
public class Librarian_Forgot_Password extends JFrame {
    ...
    public Librarian_Forgot_Password(String s) {
        super(s);
        // setSize(1080,780);
    ...
    public void create_component() {
        ...
        hl = new JLabel("Librarian Forgot Password", JLabel.CENTER);
            ...
            if (con != null) {
                if (e.getSource() == back) {
                    ...
                    if (user.isEmpty()) {
                        ...
                        String q = "SELECT name,security_question FROM librarian WHERE username=?";
                        try {
                    ...
                    if (sans.isEmpty()) {
                        ...
                        String q = "SELECT password FROM librarian WHERE username=? && security_question=? && answer=?";
