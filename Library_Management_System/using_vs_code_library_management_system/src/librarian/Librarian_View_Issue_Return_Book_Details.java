...
public class Librarian_View_Issue_Return_Book_Details extends JFrame {
    ...
    public Librarian_View_Issue_Return_Book_Details(String s, Connection con, String name, String user) {
        super(s);
        // setSize(1080,780);
    ...
    public void create_component() {
        ...
        weltext = new JLabel("Librarian View Issue and Return Book Details", JLabel.CENTER);
