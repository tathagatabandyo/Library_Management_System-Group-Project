...
public class Student_Forgot_Password extends JFrame {
    ...
    public Student_Forgot_Password(String s) {
        super(s);
        // setSize(1080,780);
    ...
    public void create_component() {
        ...
        hl = new JLabel("Student Forgot Password", JLabel.CENTER);
        ...
        al = new JLabel[5];
        al[0] = new JLabel("Roll Number", JLabel.CENTER);
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (con != null) {
                if (e.getSource() == back) {
                    ...
                    String std_roll = auser.getText().trim();
                    if (std_roll.isEmpty()) {
                        JOptionPane.showMessageDialog(null, "Field the Roll Number", "WARNING",
                                JOptionPane.WARNING_MESSAGE);
                    } else {
                        String q = "SELECT name,security_question FROM student WHERE roll_no=?";
                        try {
                            PreparedStatement ps = con.prepareStatement(q);
                            ps.setString(1, std_roll);
                            ...
                            if (rs.next()) {
                                ...
                                JOptionPane.showMessageDialog(null, "This Roll Number is Invalid", "WARNING",
                                        JOptionPane.WARNING_MESSAGE);
                            }
                        } catch (SQLException e1) {
                            JOptionPane.showMessageDialog(null, e1.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                    ...
                    if (sans.isEmpty()) {
                        ...
                        String q = "SELECT password FROM student WHERE roll_no=? && security_question=? && answer=?";
                        ...
                        try {
                            ...
                            if (rs.next()) {
                                ...
                                JOptionPane.showMessageDialog(null, "Security answer doesn't match", "WARNING",
                                        JOptionPane.WARNING_MESSAGE);
                            }
                        } catch (SQLException e1) {
                            JOptionPane.showMessageDialog(null, e1.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
