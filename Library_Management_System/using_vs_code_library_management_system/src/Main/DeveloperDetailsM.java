...
public class DeveloperDetailsM extends JFrame {

    private static final long serialVersionUID = 1L;

    public JPanel[] p, pt;
    public JPanel borderp, p1, p3, p4, p5, q1, q2, q3;
    public JLabel htext, im1, im2, im3, n1, n2, n3, ro1, ro2, ro3, branch1, branch2, branch3, y1, y2, y3, s1, s2, s3,dd[], dt[];
    JButton exit, back;
    JScrollPane ms;

    public DeveloperDetailsM(String s) {
        super(s);
        // setSize(1080,780);
    ...
    public void create_component() {
        ...
        p[0].setPreferredSize(new Dimension(10, 75));
    ...
    public void set_Layout() {
        ...
        p[4].setLayout(new GridLayout(1, 3, 20, 0));
    ...
    public void set_Border() {
        ...
        p[4].setBorder(BorderFactory.createMatteBorder(20, 20, 20, 20, color));
    ...
    public void set_color() {
        ...
        p[0].setBackground(color1);
        p[4].setBackground(color);
    ...
    public void set_font_and_Cursor() {
        ...
        htext.setFont(new Font("Tahoma", Font.BOLD, 22));
        exit.setFont(af);
        back.setFont(af);
