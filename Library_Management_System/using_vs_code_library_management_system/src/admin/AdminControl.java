...
public class AdminControl extends JFrame {
    ...
    public AdminControl(String s, Connection con, String name, String user) {
        super(s);
        // setSize(1080, 780);
    ...
    public void create_component() {
        ...
        admintext = new JLabel("Admin Control Panel", JLabel.CENTER);
        ...
        b = new JButton[8];
        b[0] = new JButton(new ImageIcon(getClass().getResource("/photo/admin.png")));
        b[1] = new JButton(new ImageIcon(getClass().getResource("/photo/librarian.png")));
        b[2] = new JButton(new ImageIcon(getClass().getResource("/photo/student.png")));
        b[3] = new JButton(new ImageIcon(getClass().getResource("/photo/book.png")));
        b[4] = new JButton(new ImageIcon(getClass().getResource("/photo/search_Book.png")));
        b[5] = new JButton(new ImageIcon(getClass().getResource("/photo/issue_book.png")));
        b[6] = new JButton(new ImageIcon(getClass().getResource("/photo/return_book.png")));
        b[7] = new JButton(new ImageIcon(getClass().getResource("/photo/book_datails.png")));

        ml = new JLabel[8];
        ml[0] = new JLabel("Manage Admin", JLabel.CENTER);
        ml[1] = new JLabel("Manage Librarian", JLabel.CENTER);
        ml[2] = new JLabel("Manage Student", JLabel.CENTER);
        ml[3] = new JLabel("Manage Book", JLabel.CENTER);
        ml[4] = new JLabel("Search Book", JLabel.CENTER);
        ml[5] = new JLabel("Issue Book", JLabel.CENTER);
        ml[6] = new JLabel("Return Book", JLabel.CENTER);
        ml[7] = new JLabel("Issue and Return Book Details", JLabel.CENTER);

        b[0].setToolTipText("Manage Admin");
        b[1].setToolTipText("Manage Librarian");
        b[2].setToolTipText("Manage Student");
        b[3].setToolTipText("Manage Book");
        b[4].setToolTipText("Search Book");
        b[5].setToolTipText("Issue Book");
        b[6].setToolTipText("Return Book");
        b[7].setToolTipText("Issue and Return Book Details");
    ...
    public void set_Layout() {
        ...
        p[6].setLayout(new GridLayout(2, 4, 15, 40));
    ...
    public void set_Border() {
        ...
        p[6].setBorder(BorderFactory.createMatteBorder(20, 15, 20, 15, new Color(41, 128, 185)));
        ...
        public void actionPerformed(ActionEvent e) {
            if (con != null && EstablishConection.getEstblishConnection() != null) {
                if (e.getSource() == logout) {
                    ...
                    dispose();
                    new Manage_Admin("Manage Admin", con, name, user).setVisible(true);
                } else if (e.getSource() == b[1]) {
                    dispose();
                    new Manage_Librarian("Manage Librarian", con, name, user).setVisible(true);
                } else if (e.getSource() == b[2]) {
                    dispose();
                    new Admin_Manage_Student("Admin Manage Student", con, name, user).setVisible(true);
                } else if (e.getSource() == b[3]) {
                    dispose();
                    new Admin_Manage_Book("Admin Manage Book", con, name, user).setVisible(true);
                } else if (e.getSource() == b[4]) {
                    dispose();
                    new Admin_Search_Book("Admin Search Book", con, name, user).setVisible(true);
                } else if (e.getSource() == b[5]) {
                    dispose();
                    new Admin_Issue_Book("Admin Issue Book", con, name, user).setVisible(true);
                } else if (e.getSource() == b[6]) {
                    dispose();
                    new Admin_return_Book("Admin Return Book", con, name, user).setVisible(true);
                } else if (e.getSource() == b[7]) {
                    dispose();
                    new Admin_View_Issue_Return_Book_Details("Admin View Issue and Return Book Details", con, name,
                            user).setVisible(true);
                } else if (e.getSource() == bi) {
                    dispose();
                    new AdminProfile("Admin Profile", con, name, user).setVisible(true);
                } else if (e.getSource() == bj) {
                    dispose();
                    new DeveloperDetailsA("Developer Details", con, name, user).setVisible(true);
